...
export const GENERATED_AT = "2026-09-11T00:00:00Z";
export const APPROX_TOKENS = 3911;
export const FAQ = [
  {
    ...
    "a": "He's exploring Backend Engineering, AI/ML, Generative AI and Software Engineering roles — somewhere he can keep building production-scale systems. He's open to opportunities right now."
  },
  {
    "id": "faq.availability",
    "q": [
  ...
  },
  {
    ...
    "a": "He's based in Nagpur, India. Anything more specific about location or relocation is worth asking him directly at kttripathi317@gmail.com."
  },
  {
    "id": "faq.education",
    "q": [
    ...
    "a": "B.Tech in Computer Science and Engineering, specialising in Data Science and Analytics, at IIIT Nagpur — November 2022 to June 2026. CGPA 8.11."
  },
  {
    ...
    "a": "One six-month backend internship at Zhecker Technologies, July to December 2025, plus five projects he's built and deployed himself. He's a recent graduate looking for entry-level roles."
  },
  {
    "id": "faq.frontend",
    "q": [
    ...
    "a": "He's a backend engineer — that's the honest answer. JavaScript, TypeScript, Vue and Tailwind are on his list, and he built his portfolio in Vue. React and Next.js are not."
  },
  {
    "id": "faq.cloud",
    "q": [
    ...
    "a": "Not on his list. His deployment experience is Docker and Docker Compose, plus Render and Cloudflare for hosting. Cloud platforms and orchestration are a gap, not a claim."
  },
  {
    "id": "faq.ml",
    "q": [
  ...
  },
  {
    ...
    "a": "He built it. One Cloudflare Worker for the API, Workers KV for the personalisation token, D1 for the event log. Answers come from Gemini with automatic failover to Groq, and the speech comes from a text-to-speech model. There's no vector database — the whole corpus is small enough to go into the prompt whole. It costs zero rupees a month to run."
  },
  {
    "id": "faq.contact",
    "q": [
    ...
    "a": "kttripathi317@gmail.com reaches him directly. His resume, GitHub, LinkedIn and LeetCode are all linked from the portfolio."
  }
];
export const PROJECTS = [
  ...
  },
  {
    "id": "proj.splitease",
    "name": "SplitEase",
    "one_liner": "Expense-sharing platform with a greedy settlement algorithm and an AI financial assistant that reads live group balances."
  },
  {
    "id": "proj.payout",
    "name": "Payout System",
    "one_liner": "Backend financial ledger — correctness under concurrency was the hard part."
  },
  {
    "id": "proj.clilogin",
    "name": "CLI Login System",
    "one_liner": "A command-line authentication tool with TOTP two-factor auth, written in Go."
  }
];
export const PERSON = {
  "name": "Kshitij Tripathi",
